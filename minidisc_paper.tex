...
\end{equation}
The terms on the right hand side of \eqref{epsEvolution} are energy loss due to advection, expansion, and cooling respectively.  The Riemann solver already takes into account advection and expansion, so to first order in time we can consider just the evolution due to cooling
\begin{equation}
