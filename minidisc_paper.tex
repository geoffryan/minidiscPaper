...
%\tablewidth{0pt}
\tablehead{\colhead{Name} &\colhead{$\dot{M}$} & \colhead{$\mathcal{M}(a)$} & \colhead{$r_{in}$} & \colhead{$q$} & \colhead{$N_r$} & \colhead{Time}}
\startdata
Model 1 & $2\times10^{-2}$ & ? & $4M$ & $0.11$ & $256$ & $29T_{bin}$ \\
Model 2 & $2\times10^{-3}$ & ? & $4M$ & $0.11$ & $256$ & $29T_{bin}$ \\
Model 3 & $2\times10^{-4}$ & ? & $4M$ & $0.11$ & $256$ & $29T_{bin}$
\enddata
\end{deluxetable}
...
\end{equation}
If angular momentum transport in minidiscs is completely due to shocks $\tau_{irr}$ should match $\tau_Re$.
