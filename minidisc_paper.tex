...
\end{equation}
{\bf For the system we consider $a=100 M_{bin}$ and $q=0.1$, so $T_{merger} \approx 3.7\times 10^3 T_{bin}$.  The simulations run for $\approx 30 T_{bin}$, so we do not include evolution of the binary orbital parameters at this time.}
