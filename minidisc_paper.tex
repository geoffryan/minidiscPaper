...
\end{equation}
This is very similar to the energy variable $\tau$ used by \citep{HARM, Duez05} (CITE FONT? (for Valencia formulation)):
\begin{equation}
...
After the LIGO discovery of GW150914 and GW151226 electromagnetic counterparts to stellar mass black hole binaries are of great interest \citep{LIGO16GW150914Discovery, LIGO16GW151226}.  If a black hole binary exists in a gaseous environment, for instance within an AGN disc \citep{Bartos16} or post supernova fallback \citep{Perna16}, it will undergo circumbinary accretion and minidisks will form potentially producing distinct radiative signatures.  
